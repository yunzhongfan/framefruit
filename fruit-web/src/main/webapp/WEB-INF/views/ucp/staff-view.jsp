...
<fieldset>
    ...
    <span>工号：</span>
    <input name="staffId" value="${staff.staffId}" type="text" class="easyui-validatebox" data-options="required: true, autoFocus: true" /><hr />
    <span>姓名：</span>
    ...
    <hr/>
    <span>状态：</span>
    <input id="Radio3" name="staffStatus" type="radio" value="1"/><label for="Radio3">正常</label>
