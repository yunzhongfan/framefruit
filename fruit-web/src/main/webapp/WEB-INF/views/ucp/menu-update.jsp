...
<fieldset>
   ...
   <!--  <span>编号：</span>
    ...
    <span>名&nbsp;&nbsp;称：</span>
    <input name="menuName" type="text" value="${menu.menuName }" class="easyui-validatebox" data-options="required: true, prompt: '请输入菜单名称'" /><hr />
    <span>类&nbsp;&nbsp;型：</span>
    ...
    <hr/>
    <span>路&nbsp;&nbsp;径：</span>
    <input name="url" type="text" value="${menu.url }" class="easyui-validatebox" data-options="required: true, prompt: '请输入菜单路径'" /><hr />
    <span>所属上级：</span>
