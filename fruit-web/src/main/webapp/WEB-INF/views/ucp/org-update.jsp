...
<fieldset>
    ...
    <input id="orgId" value="${org.orgId}" type="text" class="easyui-validatebox" disabled="disabled" data-options="required: true, autoFocus: true" /><hr />
    <span>名称：</span>
    <input name="orgName" value="${org.orgName}" type="text" class="easyui-validatebox" data-options="required: true, prompt: '请输入名称'" /><hr />
    <span>状态：</span>
    <input id="Radio3" name="orgStatus" type="radio" value="1" /><label for="Radio3">正常</label>
    <input id="Radio4" name="orgStatus" type="radio" value="2" /><label for="Radio4">停用</label>
    <hr/>
    <span>归属：</span>
    <select id="orgTree" class="easyui-combotree" style="width:200px;"  name="parentId"
