...
function (a, b) {
    ...
    f.pt.vessel = function (a, b) {
        ...
        function () {
            ...
            return f.closeBtn && (a += '<a class="' + g[7] + " " + g[7] + (f.title ? f.closeBtn : 4 == f.type ? "1" : "2") + '" href="javascript:;">脳</a>'),
            a
        }() + "</span>" + (f.btn ?
        function () {
            var a = "";
            ...
            if (e.type[f.type] == "iframe") {
                Content_IsClose = '<div style="float: left;padding-top:5px;padding-left:15px;-moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;-khtml-user-select: none;user-select: none;"><input checked="checked" type="checkbox" id="IsdialogClose" style="vertical-align: middle;margin-bottom:2px;" /><label style=";padding-left:5px;cursor:pointer" for="IsdialogClose">纭骞跺叧闂獥鍙�</label></div>';
            }
    ...
    f.pt.creat = function () {
        ...
        switch ("string" == typeof b.area && (b.area = "auto" === b.area ? ["", ""] : [b.area, ""]), b.type) {
            ...
            case 2:
                ...
                b.content = ajaxloader + '<iframe scrolling="' + (b.content[1] || "auto") + '" allowtransparency="true" id="' + b.id + '" name="' + b.id + '" onload="$.learunUIBase.loading({ isShow: false});" frameborder="0" src="' + b.content[0] + '"></iframe>';
                break;
            case 3:
                b.title = !1,
                b.closeBtn = !1,
